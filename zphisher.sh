...
##   ET phisher : 	Automated Phishing Tool
##   Author 	: 	Ethan Leulseged
##   Version 	: 	2.3.5
...
check_update(){
	...
	if [[ $new_version != $__version__ ]]; then
		...
		if [[ -e ".zphisher.tar.gz" ]]; then
			...
			echo -ne "\n${GREEN}[${WHITE}+${GREEN}] Successfully updated! Run ET phisher again\n\n"${WHITE}
			{ reset_color ; exit 1; }
		else
...
banner() {
	cat <<- EOF
		${ORANGE}oooooooooooo ooooooooooooo      ooooooooo.   ooooo   ooooo ooooo  .oooooo..o ooooo   ooooo oooooooooooo ooooooooo.
		${ORANGE}`888'     `8 8'   888   `8      `888   `Y88. `888'   `888' `888' d8P'    `Y8 `888'   `888' `888'     `8 `888   `Y88. 
		${ORANGE} 888              888            888   .d88'  888     888   888  Y88bo.       888     888   888          888   .d88' 
		${ORANGE} 888oooo8         888            888ooo88P'   888ooooo888   888   `"Y8888o.   888ooooo888   888oooo8     888ooo88P' 
		${ORANGE} 888    "         888            888          888     888   888       `"Y88b  888     888   888    "     888`88b.  
		${ORANGE} 888       o      888            888          888     888   888  oo     .d8P  888     888   888       o  888  `88b.  
		${ORANGE}o888ooooood8     o888o          o888o        o888o   o888o o888o 8""88888P'  o888o   o888o o888ooooood8 o888o  o888o     ${RED}Version : ${__version__}

		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Ethan Leulseged (T-rex)${WHITE}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN} Author   ${RED}:  ${ORANGE}Ethan Leulseged ${RED}[ ${ORANGE}T-rex ${RED}]
		${GREEN} Github   ${RED}:  ${CYAN}https://github.com/kingsolo2716
